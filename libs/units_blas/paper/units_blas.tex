...
\begin{proof}Consider an $n \times n$ matrix $\hat M_n$, and the matrix
  $DM_2$ that contains the DCVs of all of the values in $\hat M_2$:

\[ \hat M_2 = \left[ \begin{matrix} 
...
but also that all rows have the same DDV as each other.  By Theorem
\ref{if_same_row_ddvs_then_IR}, $\hat M_n$ then has a right-identity as well.\end{proof}
