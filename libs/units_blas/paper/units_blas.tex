...
\[ \hat A_4 = \left[ \begin{matrix} 
 ...
 \hat B_4 = \left[ \begin{matrix} 
  ...
  \hat 1 & 1 \cdot m & \hat 1 & 1 \cdot m \\
  1 \cdot m^{-1} & \hat 1 & 1 \cdot m^{-1} & \hat 1
 \end{matrix} \right], \] etc.  Now, consider the $n \times n$
dimensional value matrices $\hat I_{A_n}$ and $\hat I_{B_n}$.  Let the
elements of $\hat I_{A_n}$ be $\hat 1$ on the diagonals, and $\hat 0$
