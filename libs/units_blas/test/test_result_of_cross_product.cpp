...
typedef bub::make_matrix<
    ...
    >
>::type F_matrix_3x1_mixed_fundamentals_type;
...
typedef bub::make_matrix<
    boost::fusion::vector<
        ...
        boost::fusion::vector<float>
    >
>::type F_cross_F_manual;

typedef bub::make_matrix<
    boost::fusion::vector<
        boost::fusion::vector<int, int, long>
    >
>::type G_matrix_1x3_mixed_fundamentals_type_1;

typedef bub::make_matrix<
    boost::fusion::vector<
        boost::fusion::vector<int, int, int>
    >
>::type H_matrix_1x3_mixed_fundamentals_type_2;
...
typedef bub::make_matrix<
    boost::fusion::vector<
        ...
        boost::fusion::vector<length>
    >
>::type I_matrix_3x1_mixed_units_type;
...
typedef bub::make_matrix<
    boost::fusion::vector<
        ...
        boost::fusion::vector<length_sq>
    >
>::type I_cross_I_manual;

typedef bub::make_matrix<
    boost::fusion::vector<
        boost::fusion::vector<time_, length, frequency>
    >
>::type J_matrix_1x3_mixed_units_type;
