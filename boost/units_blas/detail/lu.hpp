...
namespace boost { namespace units_blas { namespace detail {
    ...
    struct update_set_pair :
        mpl::lambda<Pair>::type
    {};

    template <typename Pair, typename ValueType, typename Dim, typename System>
    struct update_set_pair<
        Pair,
        units::quantity<units::unit<Dim, System>, ValueType>
    > :
        mpl::lambda<
            mpl::pair<
                typename mpl::insert<
